                ...
                <ul>
                  ...
                  <li class="mb-8 pb-8 border-b border-gray-200">
                    <div class="px-2">
                      ...
                      <p class="text-gray-600 italic text-sm pl-12">
                        Uses <a href="https://www.npmjs.com/package/detergent" class="text-blue-500 hover:text-blue-700" target="_blank" rel="noopener noreferrer">detergent</a> to clean up your text.
                      </p>
                    </div>
                    <div class="px-2 mt-6" v-show="transformers.cleaner.tools.detergent.enabled">
                      <h3 class="text-base text-black font-semibold mb-6">Options</h3>
                      <ul class="px-2">
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Try to fix any broken named HTML entities like <code class="inline-code">&amp;nsp;</code> ('b' missing).
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Replace the last space in paragraph with a non-breaking space.
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Encode all non-<a href="https://en.wikipedia.org/wiki/ASCII" target="_blank" rel="nofollow noopener noreferrer" class="text-blue-500 hover:text-blue-700">ASCII</a> chars.
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Typographically-correct the n/m-dashes.
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Typographically-correct the apostrophes.
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Replace all line breaks with <code class="inline-code">&lt;br&gt;</code>.
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Put everything on one line (removes any line breaks, inserting space where necessary).
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Add closing slashes (i.e. <code class="inline-code">&lt;br /&gt;</code>).
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Skip non-latin character encoding (for example, CJK, Alefbet Ivri or Arabic abjad).
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Adds missing spaces after dots/colons/semicolons, unless it's an URL.
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            Convert three dots into <code class="inline-code">&amp;hellip;</code> - ellipsis character. When set to <code class="inline-code">false</code>, all encoded ellipses will be converted to three dots.
                          </p>
                        </li>
                        <li class="mb-6">
                          <div class="checkbox-toggle">
                          ...
                          <p class="text-gray-600 italic text-sm pl-12">
                            By default, all HTML tags are stripped (with exception to <code class="inline-code">opts.keepBoldEtc</code> - option to ignore <code class="inline-code">b</code>, <code class="inline-code">strong</code> and other tags). You can turn off HTML tag removal completely here.
                          </p>
                        </li>
                        <li class="mb-6">
                          <label for="stripHtmlButIgnoreTags" class="flex mb-2 cursor-pointer">stripHtmlButIgnoreTags</label>
                          <p class="text-gray-600 italic text-sm mb-4">
                            List zero or more strings, each meaning a tag name that should not be stripped. For example, <code class="inline-code">["a", "sup"]</code>.
                          </p>
                          <div>
                            <tags-input class="form-input" v-model="transformers.cleaner.tools.detergent.options.stripHtmlButIgnoreTags">
                              <div class="tags-input" slot-scope="{ tags, removeTag, inputAttrs, inputEvents }">
                                <span class="tags-input-tag" v-for="(tag, index) in tags" :key="index">
                                  <span>{{ tag }}</span>
                                  <button type="button" class="tags-input-remove" @click="removeTag(tag)">
                                ...
                                <input id="stripHtmlButIgnoreTags" class="tags-input-text" placeholder="Type and hit Enter..." v-on="inputEvents" v-bind="inputAttrs">
                              </div>
                            </tags-input>
                          </div>
                        </li>
